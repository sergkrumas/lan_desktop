...
- (21 мар 24) полученный скриншот теперь выводится в окне, окно показывается сразу при получении скриншота
...
- показывать на удалённом компьютере нажимаемые и зажимаемые клавиши, а также кнопки и колесо мыши
