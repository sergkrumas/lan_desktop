...
- (6 апр 24) задание нестандартной области захвата из портала
    ...
    - управление
        - зумирование: вращение колеса мыши
        - панорамирование: перемещение с зажатым колесом мыши
        - задание области захвата: перемещение с зажатой левой кнопкой мыши
    - прописал отрисовку инфы о заданной пользователем области захвата
    - отправка данных об области захвата через клавиши `Enter` или `Return` во время режима редактирования
    ...
    - комбобокс с вариантами захвата больше не нужен, захватом можно будет управлять из главного меню портала
...
- (7 апр 24) UX: при измении принимаемой области захвата надо автоматически вызывается команда меню `View > Fit capture to portal`
